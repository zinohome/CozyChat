...
============================================================================
⚠️ DEPRECATED: Legacy ContextService（已废弃）
============================================================================
状态：已废弃，将在 v2.0 移除
废弃时间：2024-12-22
移除时间：2025-Q1

替代方案：使用 ContextServiceNew
  - 文件：backend/app/services/context/context_service_new.py
  - 集成三大引擎：Knowledge + UserProfile + ChatMemory
  - 支持意图分析和智能引擎选择
